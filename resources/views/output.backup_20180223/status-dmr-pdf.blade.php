			...
			<div class="col-md-8">
				<table>
					...
					<tr>
						...
						<td>: &nbsp;&nbsp;</td>
						<td>
							<p> {{ $input_form_6_reimburse->draft_versi }} </p>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>: &nbsp;&nbsp;</td>
						<td>
							<p> {{ $input_form_6_rutin->draft_versi }} </p>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>: &nbsp;&nbsp;</td>
						<td>
							<p> {{ $input_form_10_pu->draft_versi }} </p>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>: &nbsp;&nbsp;</td>
						<td>
							<p> {{ $input_form_10_pk->draft_versi }} </p>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>: &nbsp;&nbsp;</td>
						<td>
							<p> {{ $input_form_10_pln->draft_versi }} </p>
						</td>
					</tr>
				</table>
			</div>
