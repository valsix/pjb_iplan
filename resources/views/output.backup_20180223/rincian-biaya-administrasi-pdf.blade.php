                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                      ...
                      <tr>
                         ...
                         <th rowspan="4" style="text-align: center; vertical-align: middle; ">No PRK</th>
                         <th rowspan="3" style="text-align: center; vertical-align: middle; ">RINCIAN</th>
                         <th rowspan="3" style="text-align: center; vertical-align: middle; ">Prak Real <br> {{ $input_tahun-1 }}</th>
                         <th rowspan="3" style="text-align: center; vertical-align: middle; ">RKAP <br> {{ $input_tahun }}</th>
                      </tr>
                      <tr>
                      </tr>
                      <tr>
                      ...
                      <body>
                        <?php
                          if ($input_tahun != NULL && $input_lokasi != NULL && $input_fase != NULL && $input_draft != NULL) {
                            for ($i = 0 ; $i < $count-1 ; $i++) { ?>
                              <tr>
                                <td style="text-align: center;">{{ $number[$i]->value }}</td>
                                <td style="text-align: center;">{{ $noprk[$i]->value }}</td>
                                <td style="text-align: center;">{{ $rincian[$i]->value }}</td>
                                <td style="text-align: right;">{{ $newEstimasi[$i],0, ",","." }}</td>
                                <td style="text-align: right;">{{ $newRkap[$i],0, ",","." }}</td>
                              </tr>
                        <?php
                        	$j = $i+1;
                            } ?>
                            <tr>
                              <td></td>
                              <td></td>
                              <td style="text-align: center"><b>TOTAL ADMINISTRASI</b></td>
                              <td style="text-align: right;">{{ $newEstimasi[$j],0, ",","." }}</td>
                              <td style="text-align: right;">{{ $newRkap[$j],0, ",","." }}</td>
                            </tr>
                        <?php
                          }
                        ?>
