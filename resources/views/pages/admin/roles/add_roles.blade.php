@extends('layouts.app')
@section('content')
<h3>{{is_null($roles) ? 'Tambah Grup Baru' : 'Edit Grup'}}</h3>
                        ...
                        <label>Nama Menu Akses*</label>
                            <div class="row">
                                <div class="col-md-10">
                                     ...
                                     <span class="help_block">Link Detail Keterangan <a target="_blank" href="{{route('admin.permission.list')}}">Menu Akses</a></span>
                                </div>
