                          ...
                          <div>
                            ...
                            {{ csrf_field() }}  
                              <div class="row"> 
                                ...
                                <div class="col-md-6">
                                <select name="fase_id" class="form-control" disabled="disabled">
                                  <?php foreach($fases as $key): ?>
                                      <option value="{{ $key->id }}"
                                      <?php if ($key->id == $approval->name) : ?>
                                        selected
                                      <?php endif ?>
                                      >{{$key->name}} 
                                      </option>
                              ...
                              <br>
                                <div class="row">
                                  ...
                                  <div class="col-md-6 {{ $errors->has('urutan') ? ' has-error' : '' }}"> 
                                    <input class="form-control" value="{{ $approval->urutan }}"  type="text" name="urutan" required>
                              ...
                              <br>
                                  <div class=" col-xs-12 col-md-offset-4">
                                    ...
                                    <a href="{{ url('/approval/daftar') }}"><button  class="btn btn-default" >Kembali</a>                       
                                  </div>
                                </form>
                            </div>
                          </div>
