                            ...
                            <div class="col-lg-13">
                              ...
                              <!-- <input type="hidden" name="_token" value="{{ csrf_token() }}"> -->
                               {{ csrf_field() }} 
                                ...
                                <div class="col-md-6"> <input value="{{ old('desc_prk_parent') }}" class="form-control" type="text" name="desc_prk_parent" required="required"></div>
                                <br>
                                <br>

                                <div class="col-md-4"><label> Identitas Prk Parent </label> </div>
                                <div class="col-md-6 {{ $errors->has('identity_prk_parent') ? ' has-error' : '' }}">
                                <input value="{{ old('identity_prk_parent') }}" class="form-control" type="text" name="identity_prk_parent" required="required">
                                ...
                                <input value="{{ old('name_prk_parent') }}" class="form-control" type="text" name="name_prk_parent" required="required">
