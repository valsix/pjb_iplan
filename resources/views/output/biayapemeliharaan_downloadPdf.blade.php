...
<head>
	...
	<title>Laporan Biaya Pemeliharaan</title>
	<!-- Chart.js') }} -->
...
<body onload="countDown();">
	...
	<div class="col-md-8">
		...
		<center><h2>LAPORAN BIAYA PEMELIHARAAN</h2></center>
	</div>
	<div class="col-md-4">
		&nbsp;
	</div>
            ...
            <script type="text/javascript">
              Highcharts.chart('rincian-aktifitas-pemeliharaan', {
                  chart: {
                    ...
                    title: {
                        text: 'Rincian Biaya Pemeliharaan'
                    },
                    tooltip: {
...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>Anggaran Biaya Pemeliharaan Per Aktivitas</h2>
