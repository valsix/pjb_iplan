...
<head>
	...
	<title>Laporan Biaya Pemeliharaan Reimburse</title>
	<!-- Chart.js') }} -->
	...
	<div class="col-md-8">
      ...
      <tr>
        ...
        <td><label class="col-md-2 col-md-3">{{ $fase }}</label></td>
			...
			<tr>
				<td>
					<label class="col-md-2 col-md-3 " >Form 6 - Reimburse</label>
				</td>
				<td>&nbsp;: &nbsp;&nbsp;</td>
				<td><label class="col-md-2 col-md-3">{{ isset($input_reimburse) ? $input_reimburse->draft_versi.' - '.$input_reimburse->name : '' }}</label></td>
			</tr>
		</table>
		<center><h2>LAPORAN BIAYA PEMELIHARAAN REIMBURSE</h2></center>
	</div>
	<div class="col-md-4">
		&nbsp;
	</div>
            ...
            <script type="text/javascript">
              Highcharts.chart('rincian-aktifitas-pemeliharaan', {
                  chart: {
                    ...
                    title: {
                        text: 'Rincian Biaya Pemeliharaan Reimburse'
                    },
                    tooltip: {
