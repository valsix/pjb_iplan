<table>
    ...
    <tr>
        <td>Draft RKAU</td>
        <td>{{ $input_draft_rkau->draft_versi }}</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>{{ $input_draft_form_6_rutin->draft_versi }}</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>{{ $input_draft_form_10_pk->draft_versi }}</td>
    </tr>
    <tr>
        <td>Draft Form 10 PLN</td>
        <td>{{ $input_draft_form_10_pln->draft_versi }}</td>
    </tr>
    <tr>
