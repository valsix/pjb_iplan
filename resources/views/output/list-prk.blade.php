            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <h2 style="font-size: 18px; margin-right: 10px;">LIST PRK</h2>
                  ...
                  <div style="overflow-x:auto;">
                    <table id="table-list-prk" class="table table-striped table-bordered" style="font-size:11px;">
                       <thead style="background:#2A3F54;color:white;">
                         <tr>
                           <th style="vertical-align: middle;">Aksi</th>
                           <th style="vertical-align: middle;">No PRK</th>
                           <th style="vertical-align: middle;">PRK Parent</th>
                           <th style="vertical-align: middle;">PRK Inti</th>
                           <th style="vertical-align: middle;">PRK Kegiatan</th>
                           <th style="vertical-align: middle;">Anggaran</th>
                           <th style="vertical-align: middle;">Disburse</th>
                         </tr>
                       </thead>
                       <body>
                        <?php $baris = 0; ?>
                        ...
                        <!-- parent -->
                            ...
                            @foreach($datainti[$key_form] as $key_inti=>$inti)
                                ...
                                <tr style="background:#d2e6e9;color:black;" class="hidetrinti{{$key_parent}} hidetrinit">
                                    <td><a attr="{{ $key_inti }}" class="btn btn-primary btn-xs" id="add2">+ Kegiatan</a></td>
