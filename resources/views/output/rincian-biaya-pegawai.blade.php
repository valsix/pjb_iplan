...
@section('content')
            ...
            <form  class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                  ...
                  <input type="text" name="draft_rkau" class="form-control col-md-12 col-xs-12" value="{{isset($input_draft->id) ? $input_draft->draft_versi.' - '.$input_draft->name : ''}}" readonly="readonly" />
                </div>
                </div>
              </div>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2 style="font-size: 18px; margin-right: 10px;">ANGGARAN BIAYA KEPEGAWAIAN</h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="table-biaya-pegawai" class="table table-striped table-bordered" style="font-size:11px;">
