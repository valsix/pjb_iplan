    ...
    <div role="main">
          <div class="">
            ...
            <div class="panel panel-default">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form>
                                ...
                                <div class="col-md-2"><label> Satuan Unit</label></div>
                                <div class="col-md-4">
                                    <input type="text" class="form-control" name="">
                                </div>
                                ...
                                <div class="col-md-2"><label> Struktrur Bisnis</label></div>
                                <div class="col-md-4">
                                    ...
                                    $(document).ready(function() {
                                        $('select[name="strategi_bisnis"]').on('change', function() {
                                            ...
                                            if(strategi_bisnisID) {
                                                $.ajax({
                                                    // url: '/rencana_kerja/ajax/'+strategi_bisnisID,
                                                    url: "{{ url('/rencana_kerja/ajax/') }}/"+strategi_bisnisID,
                                                    type: "GET",
                                                    dataType: "json",
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        $('select[name="distrik"]').on('change', function() {
                                            ...
                                            if(lokasiID) {
                                                $.ajax({
                                                    // url: '/rencana_kerja/ajax2/'+lokasiID,
                                                    url: "{{ url('/rencana_kerja/ajax2/') }}/"+lokasiID,
                                                    type: "GET",
                                                    dataType: "json",
                                                    success:function(data) {
              ...
              <div> <a href="tambah_rencana_kerja" class="btn btn-primary"> Tambah Rencana Kerja </a> </div>
              <br>
                <div class="x_content">
                  <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    @foreach ( $rencanakerja as $item)
                        <tr>
                          ...
                          <td>{{ $item->rkap_n_1 }}</td>
                          <td>{{ $item->prak_real_n_1 }}</td>
                          <td>{{ $item->rkap_n }}</td>
                          <td> 
                          
                          <a href="update_rencana_kerja/{{ $item['id'] }}"><button type="button" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span></button></a>

                          <a href="delete_rencana_kerja/{{ $item['id'] }}" class="btn btn-danger btn-xs" data-toggle="tooltip" title="hapus" onclick="return konfirmasi()"> <span class="glyphicon glyphicon-trash"></span> </a>
                          </td>
                        </tr>
