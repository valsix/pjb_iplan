                  ...
                  <table class="table table-striped table-bordered table-hover" id="datatable">
                    <thead style="background:#2A3F54;color:white">
                        <tr>
						  ...
						  <th style="vertical-align: middle;">Anggaran PRK Input</th>
                          <!-- <th>No PRK</th>
                          <th>Nama PRK</th> -->
                    ...
                    @foreach($approval_dmr as $ap)
                        <tr>
                          ...
                          <td>{{ $ap->anggaran_prk_form }}</td>
						  <td>{{ $ap->jumlah_anggaran }}</td>
						  <!-- <td>{{ $ap->no_prk }}</td>
                          <td>{{ $ap->nama_prk }}</td> -->
                          {{--
                          <td>
                          ...
                          <td>
                              <a href="{{ url('dmr/detail/'.$ap['id']) }}" class="btn btn-primary btn-xs" data-toggle="tooltip" title="detail">
