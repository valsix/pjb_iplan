                ...
                <div class="x_content">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form target="_blank" onsubmit="reDir()" method="POST" action="{{ route('fileimport.import.use', ['version_id' => $version->id, 'id' => $id]) }}" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                    ...
                    <a href="{{ route('template.show', ['jenis_id' => $version->template->jenis_id, 'id'=>$version->template_id]) }}" class="btn btn-primary"> Back </a>
                    ...
                    @if ($version->template->jenis_id != 2 && $version->template->jenis_id != 3)
                      <div class="x_panel">
                              <div class="x_title">
                                  <h2>Daftar Sheet</h2>
                                  <div class="clearfix"></div>
