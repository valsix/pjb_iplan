...
@section('content')
    <h1> Update Tahun Anggaran {{ $template->jenis->name }}</h1>
    ...
    <div class="row">
        <div class="col-md-9 col-sm-9 col-xs-9">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form method="POST" action="{{ route('template.update', ['jenis_id' => $jenis_id, 'id' => $template->id]) }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        {!! method_field('PUT') !!}
