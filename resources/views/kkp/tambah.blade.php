                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="hidden" name="distrik_id" value="{{$distrik->id}}">
                                    </div>
                                </div><br>
                                @if($bidang_divisi)
                                    <div class="row bagianclass">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="hidden" name="bidang_divisi_id" value="{{$bidang_divisi->id}}">
                                        </div>
                                    </div><br>
                                @endif
                                <!-- Lokasi -->
                                ...
                                <div class="row {{ $errors->has('jenis_cluster') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-3">
                                        <input required class="form-control" type="text" name="jenis_cluster" value="{{ old('jenis_cluster') }}">
                                ...
                                <div class="row {{ $errors->has('anggaran_percluster') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-md-3 input-group input-group-sm" style="padding-right: 10px; padding-left: 10px;">
                                            <label class="input-group-addon" >Rp</label>
                                            <input type="text" required class="form-control"  name="anggaran_percluster" value="{{ old('anggaran_percluster') }}">
                                        <!-- </div> -->
                                        <!-- <label>Rp </label><input required class="form-control" type="text" name="jumlah_anggaran" value="{{ old('jumlah_anggaran') }}">-->
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-offset-2">
                                      ...
                                      <a href="{{ url('/kkp/daftar?tahun_anggaran='.(date('Y')+1).'&strategi_bisnis='.$distrik->strategi_bisnis_id.'&distrik='.$distrik->id) }}" class="btn btn-primary" type="reset">Kembali</a>
                                    </div>
                                </div>
                            </div>
                        </form>
