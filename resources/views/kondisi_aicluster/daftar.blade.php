...
<div  role="main">
          <div class="">
            <div class="page-title">
              <div>
                <h3> Daftar Kondisi AI Cluster</h3>
          ...
          <!-- <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-default"> 
                  ...
                  <div> <a href="create" class="btn btn-primary">Tambah Kondisi AI Cluster</a> </div>
              <br>
                <div class="x_content">
                  <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                    <?php $no=1;?>
                    @foreach ($kondisi_aicluster as $item)
                        <tr>
                          <td>{{ $no++ }}</td>
                          <td>{{ $item->name }}</td>
                          <td>{{ number_format($item->nilai_min,0,',','.') }}</td>
                          <td>{{ number_format($item->nilai_max,0,',','.') }}</td>
