          ...
          <!-- <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-default"> 
                                    ...
                                    $(document).ready(function() {
                                        $('select[name="strategi_bisnis"]').on('change', function() {
                                            ...
                                            if(strategi_bisnisID) {
                                                $.ajax({
                                                    url: '/entitas/daftar_entitas/ajax/'+strategi_bisnisID,
                                                    type: "GET",
                                                    dataType: "json",
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        $('select[name="distrik"]').on('change', function() {
                                            ...
                                            if(lokasiID) {
                                                $.ajax({
                                                    url: '/entitas/daftar_entitas/ajax2/'+lokasiID,
                                                    type: "GET",
                                                    dataType: "json",
                                                    success:function(data) {
                  ...
                  <div> 
                    <a href="create" class="btn btn-primary"> Tambah Entitas</a> 
                  </div>
                    ...
                    <?php $no=1;?>
                      @foreach ($entitas as $item)
                        <tr>
                          ...
                          <td>{{ $item->lokasi->distrik->code1 }}</td>
                          ...
                          <!-- <a href="unit" class="btn btn-success" data-toggle="tooltip" title="daftar unit"> <span class="glyphicon glyphicon-file"></span></a>
