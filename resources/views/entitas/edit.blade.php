          ...
          <div class="panel-default">
                          ...
                          <div>
                            ...
                            <form method="post" role="form"> 
                              ...
                              <br>
                                <div class="row {{ $errors->has('nama') ? ' has-error' : '' }}">
                                <div class="col-md-4"><label> Nama Lokasi </label> </div>
                                <div class="col-md-6"> <input class="form-control" value="{{ $lokasi['nama']}}" type="text" name="nama"  required>
                                  @if($errors->has('nama'))
