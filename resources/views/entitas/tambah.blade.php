               ...
               <div class="panel-default">
                          ...
                          <div>
                            ...
                            <form method="post" role="form">
                              ...
                              {{ csrf_field() }}
                              <div class="col-md-6">
                              <select name="strategi_bisnis_id" class="form-control" required>
                                 <option></option>
                                    ...
                                    $(document).ready(function() {
                                        $('select[name="strategi_bisnis_id"]').on('change', function() {
                                            ...
                                            if(strategi_bisnisID) {
                                                $.ajax({
                                                    url: '/entitas/create/ajax/'+strategi_bisnisID,
                                                    type: "GET",
                                                    dataType: "json",
                              ...
                              <script type="text/javascript">
                                    $(document).ready(function() {
                                        $('select[name="distrik_id"]').on('change', function() {
                                            ...
                                            if(lokasiID) {
                                                $.ajax({
                                                    url: '/entitas/create/ajax2/'+lokasiID,
                                                    type: "GET",
                                                    dataType: "json",
                                                    success:function(data) {
