...
@section('content')
    ...
    <h1> Edit Draft {{ $version->template->jenis->name }}</h1>
    <div class="row">
                ...
                <div class="x_content">
                    ...
                    <form method="POST" action="{{ route('fileimport.update', ['version_id' => $version->id, 'id' => $draft->id]) }}" class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input type="text" name="strategi_bisnis" value="{{ $draft->distrik->strategi_bisnis->name }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                                <input type="text" name="distrik" value="{{ $draft->distrik->name }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                                @if ($errors->has('distrik'))
                                    <span class="help-block">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-8 col-xs-12">
                              <input type="text" name="name" value="{{ $draft->name }}" required="required" class="form-control col-md-12 col-xs-12">
                            </div>
                        </div>
                        @if($version->template->jenis_id ==1)
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" name="form6_rutin_file_import_id" value="{{ $template_6_rutin }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" name="form6_reimburse_file_import_id" value="{{ $template_6_reimburse }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" name="form10_pu_file_import_id" value="{{ $template_10_pu }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" name="form10_penguatankit_file_import_id" value="{{ $template_10_penguatankit }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" name="form10_pln_file_import_id" value="{{ $template_10_pln }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" name="form_bahan_bakar_file_import_id" value="{{ $template_bahan_bakar }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                  <input type="text" name="form_penyusutan_file_import_id" value="{{ $template_penyusutan }}" required="required" class="form-control col-md-7 col-xs-12" readonly="readonly">
