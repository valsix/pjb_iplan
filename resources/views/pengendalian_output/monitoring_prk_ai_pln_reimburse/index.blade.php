          ...
          <div class="x_panel collapse">
            ...
            <div class="form-group" style="margin-top: 5px;">
              ...
              <div class="form-group">
                ...
                <input type="text" name="draft_form_10_pln" value="{{ $name_draft_form_10_pln }}" class="form-control col-md-7 col-xs-12" readonly="readonly">
                </div>
              </div>
            </div>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <h2 style="font-size: 18px;">MONITORING PRK AI PLN</h2>
                    <div class="clearfix"></div>
