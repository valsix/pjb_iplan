            ...
            <div class="page-title">
              <div>
                ...
                @endif
                  ...
                  <!-- <div class="panel panel-default">
                        ...
                        <br>
                          <div class="row">
                            <div class="col-md-12">
                              <form>
                                <div class="col-md-1"> <label> Struktur Bisnis </label> </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-1"> <label> Distrik </label> </div>
                                <div class="col-md-3">
                                    ...
                                    $(document).ready(function() {
                                        $('select[name="strategi_bisnis"]').on('change', function() {
                                            ...
                                            if(strategi_bisnisID) {
                                                $.ajax({
                                                    // url: '/lokasi/daftar_lokasi/ajax/'+strategi_bisnisID,
                                                    url: "{{ url('/lokasi/daftar_lokasi/ajax/') }}/"+strategi_bisnisID,
                                                    type: "GET",
                                                    dataType: "json",
                                ...
                                <div class="col-md-1"> <label> Lokasi </label> </div>
                                <div class="col-md-3">
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function() {
                                        $('select[name="distrik"]').on('change', function() {
                                            ...
                                            if(lokasiID) {
                                                $.ajax({
                                                    // url: '/lokasi/daftar_lokasi/ajax2/'+lokasiID,
                                                    url: "{{ url('/lokasi/daftar_lokasi/ajax2/') }}/"+lokasiID,
                                                    type: "GET",
                                                    dataType: "json",
                                                    success:function(data) {
                  ...
                  <div> <a href="create" class="btn btn-primary">Tambah Lokasi</a> </div>
              <br>
                <div class="x_content">
                  <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    @foreach ($lokasi as $item)
                        <tr>
                          <td>{{ $no++ }}</td>
                          <td>{{ $item->distrik->strategi_bisnis->name }}</td>
                          <td>{{ $item->distrik->code1 }}</td>
                          <td>{{ $item->distrik->name }}</td>
                          <td>{{ $item->name }}</td>
                          <td> 
                          <!-- <a href="detail" class="btn btn-primary" data-toggle="tooltip" title="detail"> <span class="glyphicon glyphicon-eye-open"></span></a> -->

                          <!-- <a href="daftar" class="btn btn-success btn-xs" data-toggle="tooltip" title="daftar entitas"> <span class="glyphicon glyphicon-file"></span></a> -->

                          <a href="update/{{ $item['id'] }}" class="btn btn-primary btn-xs" data-toggle="tooltip" title="edit"> <span class="glyphicon glyphicon-edit"></span></a>
