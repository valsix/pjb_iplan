...
@section('content')
    <h1> Update Setting Pengendalian {{ $template->jenis->name }}</h1>
    ...
    <div class="row">
        <div class="col-md-9 col-sm-9 col-xs-9">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form method="POST" action="{{ route('sheetpengendalian.update', ['jenis_id' => $jenis_id, 'id' => $template->id]) }}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                        {!! csrf_field() !!}
                        {!! method_field('PUT') !!}
                        ...
                        <div class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Sheet<span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
