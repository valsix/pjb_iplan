...
@section('content')
    <h3>Setting {{ $version->template->jenis->name }}</h3>
    @if(session('success'))
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_content">
                    <a href="{{ route('template.show', ['jenis_id' => $version->template->jenis_id, 'id'=>$version->template_id]) }}" class="btn btn-primary"> Kembali </a>
                    <div class="panel panel-default">
                        ...
                        <div class="panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form method="POST" id="form" action="{{ route('sheet.import', $version) }}" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent2" class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="{{ slugify($row->name) }}" aria-labelledby="home-tab">
                                <div class="x_content">
                                    <a href="{{ route('sheet.setting', ['version_id' => $version, 'id' => $row->id]) }}" class="btn btn-primary"> Setting {{ $row->name }}</a>
                                </div>
