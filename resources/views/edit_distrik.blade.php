              ...
              <div class="col-lg-13">
                ...
                <select class="form-control" disabled="disabled" name="strategi_bisnis_id">
                    <?php foreach ($strategi_bisnis as $key): ?>
                      <option value="{{ $key->id }}" <?php if($key->id == $distrik->strategi_bisnis_id) : ?> selected 
                    <?php endif ?>
                      >{{ $key->name }} </option>
                    <?php endforeach ?>
                </select>
                  ...
                  <div class="col-md-6"> <input class="form-control" type="text" value="{{ $distrik->code1 }}" name="kode_distrik" required="required" disabled="disabled">
