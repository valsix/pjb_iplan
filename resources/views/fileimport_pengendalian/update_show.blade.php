                ...
                <div class="x_content">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <form target="_blank" onsubmit="reDir()" method="POST" action="{{ route('fileimportpengendalian.import.use.update.excel', ['version_id' => $version->id, 'id' => $id]) }}" enctype="multipart/form-data">
                                        {!! csrf_field() !!}
                                        ...
                                        <div class="col-md-3">
                                            <button type="submit" id='upload' class="btn btn-primary"> Update </button>
                                        </div>
                                    </form>
                                    <br>
                                </div>
