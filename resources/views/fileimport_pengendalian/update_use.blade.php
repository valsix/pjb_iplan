    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form method="POST" id="form" action="{{ route('fileimportpengendalian.import.update.excel', ['version_id' => $version, 'id' => $id]) }}" class="form-horizontal form-label-left">
                        {!! csrf_field() !!}
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="mappingtable">
                                    ...
                                    @foreach($sheet as $key => $row)
                                        <tr>
                                            <td><input type="checkbox" name="sheet[]" value="{{ $row }}" <?php if ($row == 'I-LR' || $row == 'I-CF') {
