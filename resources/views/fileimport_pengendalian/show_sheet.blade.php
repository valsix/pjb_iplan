    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <a href="{{ route('fileimportpengendalian.show', ['version_id' => $version->id, 'id' => $id]) }}" class="btn btn-primary"> Kembali </a>
                    @if($cek_sheet_data)
                        <a href="{{ route('fileimportpengendalian.editimport', ['version_id' => $version->id, 'id' => $id, 'sheet_id' => $sheet_md->id]) }}" class="btn btn-primary"> Edit </a>
                    @endif
