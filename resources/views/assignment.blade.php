                ...
                <div class="x_content">
                  <table id="datatable" class="table table-striped table-bordered table-hover">
                    ...
                    @foreach ($fileapproval as $item)
                        ...
                        <?php endif ?>
                        >
                          <!-- <td>{{-- $no++ --}} id: {{ $item->id }}, file import id: {{ $item->file_import_id }}, lokasi: {{ $item->lokasi_id }}, jenis: {{ $item->jenis_id }} FileApproval</td> -->
                          <td>{{ $no++ }}</td>
                    ...
                    @if(!$role->is_kantor_pusat)
                      @foreach ($fileapproval_ketetapan_draft_selain_usulan_unit as $item)
                        ...
                        >
						  ...
						  @endif
                          <td>
                          <a href="{{ url('approval/detail_ketetapan_selain_usulan_unit') }}/{{ $item->tahun_anggaran }}/{{ $item->lokasi_id }}/{{ $item->jenis_id }}/{{ $item->approval->fase->id }}/{{ $item->id }}" class="btn btn-primary" data-toggle="tooltip" title="detail"> Detail</a>
                          </td>
                        </tr>
                      @endforeach
                    @endif
