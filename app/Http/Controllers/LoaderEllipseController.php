...
class LoaderEllipseController extends Controller
{
    public function Loader_Ellipse(Request $request)
    {
        ...
        if($request->input('draft_rkau')) {
            $form_rkau_ipeg_prk_parent       = $this->get_form_rkau_parent($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'E');
            ...
            $form_rkau_ipeg_prk_inti       = $this->get_form_rkau_inti($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'E');
            ...
            $form_rkau_ipeg_prk_kegiatan       = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'E');
            $form_rkau_ipeg_desc_prk_kegiatan   = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'F');
            $form_rkau_ipeg_beban_mat           = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'H');
            $form_rkau_ipeg_cash_oth_1          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'J');
            $form_rkau_ipeg_cash_oth_2          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'K');
            $form_rkau_ipeg_total_year_estimates= $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'H');

            $form_rkau_ipeg_disburse = array();
            $form_rkau_ipeg_disburse[1] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'M');
            $form_rkau_ipeg_disburse[2] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'N');
            $form_rkau_ipeg_disburse[3] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'O');
            $form_rkau_ipeg_disburse[4] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'P');
            $form_rkau_ipeg_disburse[5] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'Q');
            $form_rkau_ipeg_disburse[6] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'R');
            $form_rkau_ipeg_disburse[7] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'S');
            $form_rkau_ipeg_disburse[8] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'T');
            $form_rkau_ipeg_disburse[9] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'U');
            $form_rkau_ipeg_disburse[10] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'V');
            $form_rkau_ipeg_disburse[11] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'W');
            $form_rkau_ipeg_disburse[12] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PEG', 'X');
            ...
            foreach ($form_rkau_ipeg_prk_kegiatan as $key => $value) {
                ...
                $temp = array(
                    ...
                    'ijin_proses' => 0,
                    'disburse' => $disburse,
                    'direct_est_cost' => ((float)$form_rkau_ipeg_beban_mat[$key]) + 0,
                    'category_value' => ((float)$form_rkau_ipeg_beban_mat[$key]) + 0,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_rkau_ipeg[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_rkau_ipeg[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_rkau_ipeg[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_rkau_ipeg[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        //Start query I-ADM
            $form_rkau_iadm_prk_parent       = $this->get_form_rkau_parent($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'E');
            ...
            $form_rkau_iadm_prk_inti       = $this->get_form_rkau_inti($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'E');
            ...
            $form_rkau_iadm_prk_kegiatan       = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'E');
            $form_rkau_iadm_desc_prk_kegiatan   = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'F');
            $form_rkau_iadm_beban_mat           = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'H');
            $form_rkau_iadm_cash_oth_1          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'J');
            $form_rkau_iadm_cash_oth_2          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'K');
            $form_rkau_iadm_total_year_estimates= $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'H');

            $form_rkau_iadm_disburse = array();
            $form_rkau_iadm_disburse[1] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'M');
            $form_rkau_iadm_disburse[2] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'N');
            $form_rkau_iadm_disburse[3] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'O');
            $form_rkau_iadm_disburse[4] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'P');
            $form_rkau_iadm_disburse[5] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'Q');
            $form_rkau_iadm_disburse[6] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'R');
            $form_rkau_iadm_disburse[7] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'S');
            $form_rkau_iadm_disburse[8] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'T');
            $form_rkau_iadm_disburse[9] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'U');
            $form_rkau_iadm_disburse[10] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'V');
            $form_rkau_iadm_disburse[11] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'W');
            $form_rkau_iadm_disburse[12] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-ADM', 'X');
            // dd($form_rkau_iadm_disburse);
            foreach ($form_rkau_iadm_prk_kegiatan as $key => $value) {
                ...
                $temp = array(
                    ...
                    'ijin_proses' => 0,
                    'direct_est_cost' => ((float)$form_rkau_iadm_beban_mat[$key]) + 0,
                    'category_value' => ((float)$form_rkau_iadm_beban_mat[$key]) + 0,
                    'category_code' => 'MAT',
                    'disburse' => $disburse,
                ...
                $daftar_prk_inti_form_rkau_iadm[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_rkau_iadm[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_rkau_iadm[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_rkau_iadm[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        // Bahan bakar untuk strategi bisnis OM, ambilnya dari RKAU sheet Pendukung EP
        if ($request->input('strategi_bisnis') == '1') { // 1 == OM
            # code...
            $form_rkau_ipendukungep_prk_parent       = $this->get_form_rkau_parent($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'C');
            ...
            $form_rkau_ipendukungep_prk_inti       = $this->get_form_rkau_inti($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'C');
            ...
            $form_rkau_ipendukungep_prk_kegiatan       = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'C');
            $form_rkau_ipendukungep_desc_prk_kegiatan   = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'D');
            $form_rkau_ipendukungep_beban_mat           = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'E');
            $form_rkau_ipendukungep_cash_oth          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'F');
            $form_rkau_ipendukungep_ijin_proses          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'H');
            $form_rkau_ipendukungep_total_year_estimates= $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'E');

            $form_rkau_ipendukungep_disburse = array();
            $form_rkau_ipendukungep_disburse[1] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'K');
            $form_rkau_ipendukungep_disburse[2] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'L');
            $form_rkau_ipendukungep_disburse[3] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'M');
            $form_rkau_ipendukungep_disburse[4] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'N');
            $form_rkau_ipendukungep_disburse[5] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'O');
            $form_rkau_ipendukungep_disburse[6] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'P');
            $form_rkau_ipendukungep_disburse[7] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'Q');
            $form_rkau_ipendukungep_disburse[8] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'R');
            $form_rkau_ipendukungep_disburse[9] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'S');
            $form_rkau_ipendukungep_disburse[10] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'T');
            $form_rkau_ipendukungep_disburse[11] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'U');
            $form_rkau_ipendukungep_disburse[12] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-PENDUKUNG EP', 'V');
            ...
            foreach ($form_rkau_ipendukungep_prk_kegiatan as $key => $value) {
                ...
                $temp = array(
                    ...
                    'disburse' => $disburse,
                    'direct_est_cost' => ((float)$form_rkau_ipendukungep_beban_mat[$key]) + 0,
                    'category_value' => ((float)$form_rkau_ipendukungep_beban_mat[$key]) + 0,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_rkau_ipendukungep[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_rkau_ipendukungep[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_rkau_ipendukungep[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_rkau_ipendukungep[$parent]['category_value'] += $temp['category_value'];
        ...
        //Start query I-BIAYA USAHA LAINNYA
            $form_rkau_ibiayausahalainnya_prk_parent       = $this->get_form_rkau_parent($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'E');
            ...
            $form_rkau_ibiayausahalainnya_prk_inti       = $this->get_form_rkau_inti($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'E');
            ...
            $form_rkau_ibiayausahalainnya_prk_kegiatan       = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'E');
            $form_rkau_ibiayausahalainnya_desc_prk_kegiatan   = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'F');
            $form_rkau_ibiayausahalainnya_beban_mat           = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'H');
            $form_rkau_ibiayausahalainnya_cash_oth_1          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'J');
            $form_rkau_ibiayausahalainnya_cash_oth_2          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'K');
            $form_rkau_ibiayausahalainnya_total_year_estimates= $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'H');

            $form_rkau_ibiayausahalainnya_disburse = array();
            $form_rkau_ibiayausahalainnya_disburse[1] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'M');
            $form_rkau_ibiayausahalainnya_disburse[2] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'N');
            $form_rkau_ibiayausahalainnya_disburse[3] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'O');
            $form_rkau_ibiayausahalainnya_disburse[4] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'P');
            $form_rkau_ibiayausahalainnya_disburse[5] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'Q');
            $form_rkau_ibiayausahalainnya_disburse[6] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'R');
            $form_rkau_ibiayausahalainnya_disburse[7] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'S');
            $form_rkau_ibiayausahalainnya_disburse[8] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'T');
            $form_rkau_ibiayausahalainnya_disburse[9] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'U');
            $form_rkau_ibiayausahalainnya_disburse[10] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'V');
            $form_rkau_ibiayausahalainnya_disburse[11] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'W');
            $form_rkau_ibiayausahalainnya_disburse[12] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-BIAYA USAHA LAINNYA', 'X');
            ...
            foreach ($form_rkau_ibiayausahalainnya_prk_kegiatan as $key => $value) {
                ...
                $temp = array(
                    ...
                    'ijin_proses' => 0,
                    'disburse' => $disburse,
                    'direct_est_cost' => ((float)$form_rkau_ibiayausahalainnya_cash_oth_1[$key]) + 0,
                    'category_value' => ((float)$form_rkau_ibiayausahalainnya_cash_oth_1[$key]) + 0,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_rkau_ibiayausahalainnya[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_rkau_ibiayausahalainnya[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_rkau_ibiayausahalainnya[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_rkau_ibiayausahalainnya[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        //Start query I-DILUAR USAHA
            $form_rkau_idiluarusaha_prk_parent       = $this->get_form_rkau_parent($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'E');
            ...
            $form_rkau_idiluarusaha_prk_inti       = $this->get_form_rkau_inti($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'E');
            ...
            $form_rkau_idiluarusaha_prk_kegiatan       = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'E');
            $form_rkau_idiluarusaha_desc_prk_kegiatan   = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'F');
            $form_rkau_idiluarusaha_beban_mat           = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'H');
            $form_rkau_idiluarusaha_cash_oth_1          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'J');
            $form_rkau_idiluarusaha_cash_oth_2          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'K');
            $form_rkau_idiluarusaha_total_year_estimates= $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'H');

            $form_rkau_idiluarusaha_disburse = array();
            $form_rkau_idiluarusaha_disburse[1] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'M');
            $form_rkau_idiluarusaha_disburse[2] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'N');
            $form_rkau_idiluarusaha_disburse[3] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'O');
            $form_rkau_idiluarusaha_disburse[4] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'P');
            $form_rkau_idiluarusaha_disburse[5] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'Q');
            $form_rkau_idiluarusaha_disburse[6] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'R');
            $form_rkau_idiluarusaha_disburse[7] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'S');
            $form_rkau_idiluarusaha_disburse[8] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'T');
            $form_rkau_idiluarusaha_disburse[9] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'U');
            $form_rkau_idiluarusaha_disburse[10] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'V');
            $form_rkau_idiluarusaha_disburse[11] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'W');
            $form_rkau_idiluarusaha_disburse[12] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-DILUAR USAHA', 'X');
            ...
            foreach ($form_rkau_idiluarusaha_prk_kegiatan as $key => $value) {
                ...
                $temp = array(
                    ...
                    'ijin_proses' => 0,
                    'disburse' => $disburse,
                    'direct_est_cost' => ((float)$form_rkau_idiluarusaha_beban_mat[$key]) + 0,
                    'category_value' => ((float)$form_rkau_idiluarusaha_beban_mat[$key]) + 0,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_rkau_idiluarusaha[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_rkau_idiluarusaha[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_rkau_idiluarusaha[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_rkau_idiluarusaha[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        //Start query I-Pendapatan
            $form_rkau_ipendapatan_prk_parent       = $this->get_form_rkau_parent($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'E');
            ...
            $form_rkau_ipendapatan_prk_inti       = $this->get_form_rkau_inti($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'E');
            ...
            $form_rkau_ipendapatan_prk_kegiatan       = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'E');
            $form_rkau_ipendapatan_desc_prk_kegiatan   = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'F');
            $form_rkau_ipendapatan_beban_mat           = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'H');
            $form_rkau_ipendapatan_cash_oth_1          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'J');
            $form_rkau_ipendapatan_cash_oth_2          = $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'K');
            $form_rkau_ipendapatan_total_year_estimates= $this->get_form_rkau($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'H');

            $form_rkau_ipendapatan_disburse = array();
            $form_rkau_ipendapatan_disburse[1] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'M');
            $form_rkau_ipendapatan_disburse[2] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'N');
            $form_rkau_ipendapatan_disburse[3] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'O');
            $form_rkau_ipendapatan_disburse[4] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'P');
            $form_rkau_ipendapatan_disburse[5] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'Q');
            $form_rkau_ipendapatan_disburse[6] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'R');
            $form_rkau_ipendapatan_disburse[7] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'S');
            $form_rkau_ipendapatan_disburse[8] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'T');
            $form_rkau_ipendapatan_disburse[9] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'U');
            $form_rkau_ipendapatan_disburse[10] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'V');
            $form_rkau_ipendapatan_disburse[11] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'W');
            $form_rkau_ipendapatan_disburse[12] = $this->get_form_rkau_disburse($input_sb, $request->input('draft_rkau'), $int_input_lokasi, 'I-Pendapatan', 'X');
            ...
            foreach ($form_rkau_ipendapatan_prk_kegiatan as $key => $value) {
                ...
                $temp = array(
                    ...
                    'ijin_proses' => 0,
                    'direct_est_cost' => ((float)$form_rkau_ipendapatan_beban_mat[$key]) + 0,
                    'category_value' => ((float)$form_rkau_ipendapatan_beban_mat[$key]) + 0,
                    'category_code' => 'MAT',
                    'disburse' => $disburse,
                ...
                $daftar_prk_inti_form_rkau_ipendapatan[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_rkau_ipendapatan[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_rkau_ipendapatan[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_rkau_ipendapatan[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        if($request->input('draft_form_6_reimburse')) {
            ...
            for($i=0; $i<$int_count_6_reimburse; $i++){
                ...
                $temp = array(
                    ...
                    'disburse' => $disburse,
                    'direct_est_cost' => ((float)$form_6_reimburse_beban_mat[$i]->value) + (float)$form_6_reimburse_ijin_proses[$i]->value,
                    'category_value' =>  ((float)$form_6_reimburse_beban_mat[$i]->value) + (float)$form_6_reimburse_ijin_proses[$i]->value,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_6_reimburse[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_6_reimburse[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_6_reimburse[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_6_reimburse[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        if($request->input('draft_form_6_rutin')) {
            ...
            for($i=0; $i<$int_count_6_rutin; $i++){
                ...
                $temp = array(
                    ...
                    'disburse' => $disburse,
                    'direct_est_cost' => ((float)$form_6_rutin_beban_mat[$i]->value) + (float)$form_6_rutin_ijin_proses[$i]->value,
                    'category_value' => ((float)$form_6_rutin_beban_mat[$i]->value) + (float)$form_6_rutin_ijin_proses[$i]->value,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_6_rutin[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_6_rutin[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_6_rutin[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_6_rutin[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        if($request->input('draft_form_10_pk')) {
            ...
            $form_10_pk_disburse[12] = $this->get_form_10_disburse($request->input('draft_form_10_pk'),$int_input_lokasi, 'BN');
       		;
          	foreach ($form_10_pk_no_prk_kegiatan as $key => $value) {
          		# code...
          		$parent = substr($value->value,0,6);
                $inti = substr($value->value,0,8);

                $disburse = array();
                for($bulan=1; $bulan<=12; $bulan++){
                    $disburse[$bulan] = (float)$form_10_pk_disburse[$bulan][$key]->value;
                ...
                $temp = array(
                    ...
                    'prk_inti' => $inti,
                    'prk_parent' => $parent,
                    'desc_prk_kegiatan' => $form_10_pk_desc_prk_kegiatan[$key]->value,
                    'desc_prk_inti' => $form_10_pk_desc_prk_inti[$key]->value,
                    'desc_prk_parent' => $form_10_pk_desc_prk_parent[$key]->value,
                    'beban_mat' => (float)$form_10_pk_beban_mat[$key]->value,
                    'cash_oth' => 0,
                    'ijin_proses' => 0,
                    'direct_est_cost' => ((float)$form_10_pk_beban_mat[$key]->value) + 0,
                    'category_value' => ((float)$form_10_pk_beban_mat[$key]->value) + 0,
                    'category_code' => 'MAT',
                    'total_year_estimate' => (float)$form_10_pk_total_year_estimate[$key]->value,
                    'disburse' => $disburse,
                );
                ...
                $daftar_prk_inti_form_10_pk[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_10_pk[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_10_pk[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_10_pk[$parent]['category_value'] += $temp['category_value'];
          	}
        ...
        if($request->input('draft_form_10_pu')) {
            ...
            for($i=0; $i<$int_count_10_pu; $i++){
                ...
                $temp = array(
                    ...
                    'cash_oth' => 0,
                    'ijin_proses' => 0,
                    'direct_est_cost' => ((float)$form_10_pu_beban_mat[$i]->value) + 0,
                    'category_value' => ((float)$form_10_pu_beban_mat[$i]->value) + 0,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_10_pu[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_10_pu[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_10_pu[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_10_pu[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        if($request->input('draft_form_10_pln')) {
            ...
            for($i=0; $i<$int_count_10_pln; $i++){
                ...
                $temp = array(
                    ...
                    'cash_oth' => 0,
                    'ijin_proses' => 0,
                    'direct_est_cost' => ((float)$form_10_pln_beban_mat[$i]->value / 1.1) + 0,
                    'category_value' => ((float)$form_10_pln_beban_mat[$i]->value / 1.1) + 0,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_10_pln[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_10_pln[$inti]['category_value'] += $temp['category_value'];
                ...
                $daftar_prk_parent_form_10_pln[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_10_pln[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        if($request->input('draft_form_penyusutan')) {
            ...
            for($i=0; $i<$int_count_penyusutan; $i++){
                ...
                $temp = array(
                    ...
                    'cash_oth' => 0,
                    'ijin_proses' => 0,
                    'direct_est_cost' => ((float)$form_penyusutan_beban_mat[$i]->value) + 0,
                    'category_value' => ((float)$form_penyusutan_beban_mat[$i]->value) + 0,
                    'category_code' => 'MAT',
                ...
                $daftar_prk_inti_form_penyusutan[$inti]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_inti_form_penyusutan[$inti]['category_value'] += $temp['category_value'];

                $daftar_prk_parent_form_penyusutan[$parent]['beban_mat'] += $temp['beban_mat'];
                $daftar_prk_parent_form_penyusutan[$parent]['direct_est_cost'] += $temp['direct_est_cost'];
                $daftar_prk_parent_form_penyusutan[$parent]['category_value'] += $temp['category_value'];
            }
        ...
        // Untuk bahan bakar untuk UP nariknya dari form bahan bakar
        if ($request->input('strategi_bisnis') == '2') { // 2 == UP
            # code...
            if($request->input('draft_form_bahan_bakar')) {
                ...
                $form_bahan_bakar_prk_parent       = $this->get_form_bahan_bakar_parent($request->input('draft_form_bahan_bakar'), $int_input_lokasi, 'J');
                foreach ($form_bahan_bakar_prk_parent as $key => $value) {
                    $desc_prk_parent = $this->get_prk_parent_desc(substr($value->value, 4,2));
                    $daftar_prk_parent_form_bahan_bakar[substr($value->value, 0, 6)] = array(
                        'desc_prk_parent' => ($desc_prk_parent!= null ? $desc_prk_parent->desc_prk_parent : ''),
                        'beban_mat'     => 0,
                        'cash_oth'      => 0,
                        'ijin_proses'   => 0,
                ...
                $form_bahan_bakar_prk_inti       = $this->get_form_bahan_bakar_inti($request->input('draft_form_bahan_bakar'), $int_input_lokasi, 'J');
                ...
                foreach($jenis_bahan_bakar as $jenis) {
                    ...
                    foreach ($form_bahan_bakar_prk_kegiatan as $key => $value) {
                        ...
                        if($jenis['beban_mat4']!= null) {
                            $beban_mat4 = $this->get_form_bahan_bakar_per_prk($request->input('draft_form_bahan_bakar'),$int_input_lokasi, $jenis['beban_mat4'], $jenis['name'],'J',$value->value);
                            $temp['beban_mat'] += (float) array_sum($beban_mat4);
                        }

                        if($jenis['beban_mat5']!= null) {
                            $beban_mat5 = $this->get_form_bahan_bakar_per_prk($request->input('draft_form_bahan_bakar'),$int_input_lokasi, $jenis['beban_mat5'], $jenis['name'],'J',$value->value);
                            $temp['beban_mat'] += (float) array_sum($beban_mat5);
                        }

                        if($jenis['beban_mat6']!= null) {
                            $beban_mat6 = $this->get_form_bahan_bakar_per_prk($request->input('draft_form_bahan_bakar'),$int_input_lokasi, $jenis['beban_mat6'], $jenis['name'],'J',$value->value);
                            $temp['beban_mat'] += (float) array_sum($beban_mat6);
                        }
                        ...
                        $temp['direct_est_cost'] += $temp['beban_mat'];
                        $temp['category_value'] += $temp['beban_mat'];

                        $daftar_prk_inti_form_bahan_bakar[$inti]['beban_mat'] += $temp['beban_mat'];
                        $daftar_prk_inti_form_bahan_bakar[$inti]['direct_est_cost'] += $temp['beban_mat'];
                        $daftar_prk_inti_form_bahan_bakar[$inti]['category_value'] += $temp['beban_mat'];

                        $daftar_prk_parent_form_bahan_bakar[$parent]['beban_mat'] += $temp['beban_mat'];
                        $daftar_prk_parent_form_bahan_bakar[$parent]['direct_est_cost'] += $temp['beban_mat'];
                        $daftar_prk_parent_form_bahan_bakar[$parent]['category_value'] += $temp['beban_mat'];
                ...
                $dataparent['form_bahan_bakar'] = $daftar_prk_parent_form_bahan_bakar;
                $datainti['form_bahan_bakar'] = $daftar_prk_inti_form_bahan_bakar;
                $datakegiatan['form_bahan_bakar'] = $daftar_prk_kegiatan_form_bahan_bakar;
            }
        }
            ...
            if($request->download && $request->type){
                ...
                if($request->type=='excel'){
                    Excel::create('Loader Ellipse', function ($excel) use($sb, $fase, $input_tahun, $input_sb, $input_distrik, $input_lokasi, $input_fase, $input_draft_rkau, $input_draft_form_6_reimburse, $input_draft_form_6_rutin, $input_draft_form_10_pk, $input_draft_form_10_pu, $input_draft_form_10_pln, $input_draft_form_bahan_bakar, $input_draft_form_penyusutan, $dataparent, $datainti, $datakegiatan) {
                            $excel->setTitle('Loader Ellipse');
                            $excel->setCreator('Laravel')->setCompany('Profio', 'PJB');
                            $excel->setDescription('Loader Ellipse');
                            $excel->sheet('Loader Ellipse', function ($sheet) use($sb, $fase, $input_tahun, $input_sb, $input_distrik, $input_lokasi, $input_fase, $input_draft_rkau, $input_draft_form_6_reimburse, $input_draft_form_6_rutin, $input_draft_form_10_pk, $input_draft_form_10_pu, $input_draft_form_10_pln, $input_draft_form_bahan_bakar, $input_draft_form_penyusutan, $dataparent, $datainti, $datakegiatan){
                                $sheet->loadView('output/loader-ellipse-excel')
                                        ->with('sb', $sb)
                                        ->with('fase', $fase)
    ...
    function get_form_bahan_bakar_parent($file_import_id, $lokasi_id, $kolom) {
        $query = DB::select("select distinct SUBSTRING(e.value,1,8) as value from excel_datas e join sheets s on s.id = e.sheet_id where s.name like 'Database KIT (P+S+I)' and e.file_import_id = ".$file_import_id." and e.lokasi_id = ".$lokasi_id." and e.kolom = '".$kolom."' order by value asc;");
        return $query;
    }

    function get_form_bahan_bakar_inti($file_import_id, $lokasi_id, $kolom){
        $query = DB::select("select distinct SUBSTRING(e.value,1,8) as value from excel_datas e join sheets s on s.id = e.sheet_id where s.name like 'Database KIT (P+S+I)' and e.file_import_id = ".$file_import_id." and e.lokasi_id = ".$lokasi_id." and e.kolom = '".$kolom."' order by value asc;");
        return $query;
    }
    ...
    function get_form_10_disburse($file_import_id, $lokasi_id, $kolom){
        $query = DB::select("select (case when value = '' then 0 else value::float end) as value, e.row from excel_datas e join sheets s on s.id = e.sheet_id where s.name like 'I-Form 10' and e.file_import_id = ".$file_import_id." and e.lokasi_id = ".$lokasi_id." and e.kolom = '".$kolom."' order by row asc; ");

        return $query;
    }

    function get_form_rkau($input_sb, $file_import_id, $lokasi_id, $sheet, $kolom){

    	if($sheet == "I-Pendapatan") {
            if($input_sb->name == 'OM') { // khusus I-Pendapatan, OM hanya menampilkan pendapatan Jasa
                $query = DB::select("select e.row, e.value
                            ...
                            and e.row > 19
                            order by e.row");
            } else { // khusus I-Pendapatan, UP hanya menampilkan pendapatan komponen
                $query = DB::select("select e.row, e.value
                            from excel_datas e
                            join sheets s on s.id = e.sheet_id
                            where s.name like '".$sheet."'
    ...
    function get_form_rkau_inti($input_sb, $file_import_id, $lokasi_id, $sheet, $kolom){
    	if($sheet == "I-Pendapatan") {
            if($input_sb->name == 'OM') { // khusus I-Pendapatan, OM hanya menampilkan pendapatan Jasa
                $query = DB::select("select distinct SUBSTRING(e.value,1,6) as value
		                            ...
		                            and e.lokasi_id = ".$lokasi_id."
		                            and e.kolom = '".$kolom."'
		                            and e.row > 19 order by value asc;");
            } else { // khusus I-Pendapatan, UP hanya menampilkan pendapatan komponen
                $query = DB::select("select distinct SUBSTRING(e.value,1,6) as value
		                            from excel_datas e
		                            join sheets s on s.id = e.sheet_id
		                            ...
		                            and e.lokasi_id = ".$lokasi_id."
		                            and e.kolom = '".$kolom."'
		                            and e.row < 20 and e.row > 12 order by value asc;");
            }
        } else {
		        $query = DB::select("select distinct SUBSTRING(e.value,1,6) as value
		                            from excel_datas e
    ...
    function get_form_rkau_parent($input_sb, $file_import_id, $lokasi_id, $sheet, $kolom){
    	if($sheet == "I-Pendapatan") {
            if($input_sb->name == 'OM') { // khusus I-Pendapatan, OM hanya menampilkan pendapatan Jasa
    ...
    function get_form_rkau_disburse($input_sb, $file_import_id, $lokasi_id, $sheet, $kolom){
