...
class ApprovalKkpControllerWldn extends Controller
{
...
// DB::enableQueryLog();
        ...
        return view('approval_kkp.daftar_approval_kkp', compact('Sb', 'input_tahun', 'input_sb', 'input_distrik', 'input_lokasi', 'distrik', 'lokasi', 'approval_dmr', 'dmr_review_phase', 'role_id', 'role_spv_unit_dmr_tor', 'datrs', 'getappr', 'review_skr'));
    }
    ...
    public function approval(Request $request, $id)
    {
        if ($request->isMethod("get")) {
            ...
            $item['statskkp']= 'false';
            if ($item['dmr']['status_appr_id']==3 || $item['dmr']['status_appr_id']==6 || $item['dmr']['status_appr_id']==4) 
            {
                $item['statskkp']= 'true';
            }
        ...
        elseif ($request->isMethod('post')) {
            ...
            return redirect('approval_kkp/daftar?tahun_anggaran='.$dmr->tahun_anggaran.'&strategi_bisnis='.$dmr->lokasi->distrik->strategi_bisnis_id.'&distrik='.$dmr->lokasi->distrik_id.'&lokasi='.$dmr->lokasi_id);
        }
    }
    ...
    public function publish()
    {
        ...
        return view('approval_kkp.daftar_published_kkp', compact('Sb', 'input_tahun', 'input_sb', 'input_distrik', 'input_lokasi', 'distrik', 'lokasi', 'approval_dmr', 'role_id'));
    }
    ...
    public function send_email(Request $request)
    {
        ...
        Mail::send('approval_kkp.send', ['title' => $title, 'content' => $content], function ($message)
        {
