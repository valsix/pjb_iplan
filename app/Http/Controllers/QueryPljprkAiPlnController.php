...
class QueryPljprkAiPlnController extends Controller
{
    public function index()
    {
    	...
    	foreach ($distrik as $key => $value1) {
	    	$query_ai = $this->query_pljprk_ai_pln($value1->code1, $start_month, $finish_month);
  ...
  //   	$pljprkai->dstrct_code = ''; //not null
    ...
    public function query_pljprk_ai_pln($distrik, $start_month, $finish_month) {
