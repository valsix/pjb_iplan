...
class BiayaPemeliharaanRutinController extends Controller
{
    public function Biaya_Pemeliharaan(Request $request)
    {
        ...
        if ($input_tahun != NULL && $lokasi != NULL && $fase != NULL) {
            ...
            $oj_nilai = array_merge($oj_nilai_rutin);
            ...
            $overhaul_nilai = array_merge($overhaul_nilai_rutin);
            ...
            $engineering_nilai = array_merge($engineering_nilai_rutin);
            ...
            $nilai_non = array_merge($nilai_non_rutin);
            ...
            $nilai_operasi = array_merge($nilai_operasi_rutin);
            ...
            $nilai_kimia = array_merge($nilai_kimia_rutin);
            ...
            $nilai_k3 = array_merge($nilai_k3_rutin);
            ...
            $nilai_lingkungan = array_merge($nilai_lingkungan_rutin);
            ...
            $nilai_preventive = array_merge($nilai_preventive_rutin);
            ...
            $nilai_predictive = array_merge($nilai_predictive_rutin);
            ...
            $nilai_corective = array_merge($nilai_corective_rutin);
            ...
            $nilai_emergency = array_merge($nilai_emergency_rutin);
            ...
            $nilai_breakdown = array_merge($nilai_breakdown_rutin);
            ...
            switch ($request->download) {
                case 'pdf':
                    ...
                    return $this->downloadPDF($request, $input_tahun, $sb, $lokasi, $fase, $input_fase, $input_rutin, $oj_nilai, $overhaul_nilai, $engineering_nilai, $nilai_non, $nilai_operasi, $nilai_kimia, $nilai_k3, $nilai_lingkungan, $nilai_preventive, $nilai_predictive, $nilai_corective, $nilai_emergency, $nilai_breakdown, $total);
                    break;
                case 'excel':
                    return $this->downloadExcel($request, $input_tahun, $sb, $lokasi, $input_fase, $input_rutin, $oj_nilai, $overhaul_nilai, $engineering_nilai, $nilai_non, $nilai_operasi, $nilai_kimia, $nilai_k3, $nilai_lingkungan, $nilai_preventive, $nilai_predictive, $nilai_corective, $nilai_emergency, $nilai_breakdown, $total);
                    break;
                default:
                    return view('/output/biaya-pemeliharaan-rutin', compact('table', 'fs', 'tampil', 'tahun', 'lokasi', 'Sbisnis', 'input_distrik', 'distrik', 'input_sb', 'fase', 'oj', 'overhaul', 'subtotal', 'inspection', 'engineering', 'project', 'modifikasi', 'non', 'tu', 'sarana', 'operasi', 'kimia', 'lab', 'k3','lingkungan','preventive','predictive','corective', 'oj_nilai', 'overhaul_nilai','engineering_nilai','nilai_k3', 'nilai_lingkungan','nilai_preventive','nilai_predictive', 'nilai_corective','nilai_non', 'nilai_operasi','nilai_kimia', 'total', 'input_lokasi', 'input_fase','input_tahun', 'input_reimburse', 'input_reimburse', 'reimburse','rutin','input_rutin', 'emergency', 'nilai_emergency', 'breakdown', 'nilai_breakdown'));
                    break;
            }
        }  
        return view('/output/biaya-pemeliharaan-rutin', compact('Sbisnis','table', 'fs', 'tampil', 'tahun', 'lokasi', 'fase', 'input_distrik', 'distrik','input_sb', 'oj', 'overhaul', 'engineering', 'project', 'modifikasi', 'non', 'tu', 'sarana', 'operasi', 'kimia', 'lab','k3','lingkungan','preventive','predictive','corective','oj_nilai','overhaul_nilai','engineering_nilai','nilai_k3', 'nilai_lingkungan','nilai_preventive', 'nilai_predictive','nilai_corective','nilai_non','nilai_operasi','nilai_kimia', 'total','input_lokasi', 'input_fase','input_tahun','input_reimburse', 'reimburse','rutin','input_rutin', 'emergency', 'nilai_emergency', 'breakdown', 'nilai_breakdown'));
    }

    private function downloadPDF(Request $request, $tahun, $sb, $lokasi, $fase, $input_fase, $input_rutin, $oj_nilai, $overhaul_nilai, $engineering_nilai, $nilai_non, $nilai_operasi, $nilai_kimia, $nilai_k3, $nilai_lingkungan, $nilai_preventive, $nilai_predictive, $nilai_corective, $nilai_emergency, $nilai_breakdown, $total)
    {
        $oj    = 'Operasi Jasa';
        $overhaul    = 'Overhaul';
        $inspection  = 'Inspection';
        ...
        return view('/output/biayapemeliharaanrutin_downloadPdf',$data);
        
   }
   private function downloadExcel(Request $request, $tahun, $sb, $lokasi, $input_fase, $input_rutin, $oj_nilai, $overhaul_nilai, $engineering_nilai, $nilai_non, $nilai_operasi, $nilai_kimia, $nilai_k3, $nilai_lingkungan, $nilai_preventive, $nilai_predictive, $nilai_corective, $nilai_emergency, $nilai_breakdown, $total){
       ...
       //  $subtotal2   = number_format($subtotal1,0, ',','.');
        ...
        Excel::create('Anggaran Biaya Pemeliharaan Rutin', function($excel) use ($tahun, $sbb, $lko, $distr1, $th, $input_fase, $input_rutin, $oj, $overhaul,$inspection,$engineering,$project,$modifikasi,$non,$tu,$sarana,$operasi,$kimia,$lab,$k3,$lingkungan,$preventive,$predictive,$corective, $emergency, $breakdown, $nilai_emergency, $nilai_breakdown, $oj_nilai, $overhaul_nilai, $engineering_nilai, $nilai_non, $nilai_operasi, $nilai_kimia, $nilai_k3, $nilai_lingkungan, $nilai_preventive, $nilai_predictive, $nilai_corective, $total){
            $excel->setTitle('ANGGARAN BIAYA PEMELIHARAAN RUTIN PER AKTIVITAS');
            $excel->setCreator('Laravel-5.5')->setCompany('PJB');
            $excel->sheet('Sheet1', function($sheet) use ($tahun, $sbb, $lko,  $distr1, $th, $input_fase, $input_rutin, $oj, $overhaul,$inspection,$engineering,$project,$modifikasi,$non,$tu,$sarana,$operasi,$kimia,$lab,$k3,$lingkungan,$preventive,$predictive,$corective, $emergency, $breakdown, $nilai_emergency, $nilai_breakdown, $oj_nilai, $overhaul_nilai, $engineering_nilai, $nilai_non, $nilai_operasi, $nilai_kimia, $nilai_k3, $nilai_lingkungan, $nilai_preventive, $nilai_predictive, $nilai_corective, $total) {
                    $sheet->setWidth("B", 40);
                    $sheet->SetCellValue("B12", "ANGGARAN BIAYA PEMELIHARAAN RUTIN PER AKTIVITAS");
                ...
                $sheet->SetCellValue("B10", "Form 6 - Rutin");
                isset($input_rutin) ? $sheet->SetCellValue('C10', $input_rutin->draft_versi.' - '.$input_rutin->name) : $sheet->SetCellValue('C10', '');
