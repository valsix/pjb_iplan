...
class SummaryKkpController extends Controller
{
    public function index(Request $request)
    {
        if ($request->isMethod('get')) 
        {
            ...
            return view('kkp.summary', compact('thnselected', 'Sbisnis', 'fs', 'lokasi', 'tahun', 'input_sb', 'input_d', 'input_l', 'input_t', 'input_f'));
        }
        else if ($request->isMethod('post')) 
        {
            ...
            return view('kkp.summary', compact('lokasiall', 'distrik', 'thnselected', 'Sbisnis', 'fs', 'lokasi', 'tahun', 'input_sb', 'input_d', 'input_l', 'input_t', 'input_f'));
        }
    }
