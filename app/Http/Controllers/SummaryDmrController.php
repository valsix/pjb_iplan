...
class SummaryDmrController extends Controller
{
    public function index(Request $request)
    {
        if ($request->isMethod('get')) 
        {
            ...
            return view('dmr.summary', compact('thnselected', 'Sbisnis', 'fs', 'lokasi', 'tahun', 'input_sb', 'input_d', 'input_l', 'input_t', 'input_f'));
        }
        else if ($request->isMethod('post')) 
        {
            ...
            return view('dmr.summary', compact('lokasiall', 'distrik', 'thnselected', 'Sbisnis', 'fs', 'lokasi', 'tahun', 'input_sb', 'input_d', 'input_l', 'input_t', 'input_f'));
        }
    }
