...
class RekapLRQuery
{
  ...
  {
    $columns = RekapLRQuery::get_column_array($start_kolom, $bulan, 1);
  ...
  static function get_form_10_ai_pln($pgdl_file_import_revisi_id, $tahun, $bulan, $sheet_name_rkau, $sheet_name_form, $start_kolom, $search_column1, $search_cell_column_1, $search_cell_row_1, $search_column2, $search_cell_column_2, $search_cell_row_2, $jenis_id, $distrik)
  {

    $columns = RekapLRQuery::get_column_array($start_kolom, $bulan, 1);
    if ($jenis_id == 2)
      $form_id = RekapLRQuery::get_file_import_revisi($pgdl_file_import_revisi_id, 'form6_rutin_pgdl_file_import_revisi_id');
    elseif ($jenis_id == 3)
      $form_id = RekapLRQuery::get_file_import_revisi($pgdl_file_import_revisi_id, 'form6_reimburse_pgdl_file_import_revisi_id');
    // elseif($jenis_id == 6)
    else
      $form_id = RekapLRQuery::get_file_import_revisi($pgdl_file_import_revisi_id, 'form10_pln_pgdl_file_import_revisi_id');
  ...
  static function get_rkap_sd_bulan_non_luar_jawa($pgdl_file_import_revisi_id, $tahun, $bulan, $sheet_name, $start_kolom, $row, $lokasi_id)
  {
    $columns = RekapLRQuery::get_column_array($start_kolom, $bulan, 1);
  ...
  static function get_rkap_sd_bulan_biaya_usaha_lainnya_non_luar_jawa($pgdl_file_import_revisi_id, $tahun, $bulan, $sheet_name, $start_kolom, $search_column, $search_cell_column, $search_cell_row, $lokasi_id)
  {
    $columns = RekapLRQuery::get_column_array($start_kolom, $bulan, 1);
  ...
  static function get_rkap_sd_bulan_form_6_10_non_luar_jawa($pgdl_file_import_revisi_id, $tahun, $bulan, $sheet_name_rkau, $sheet_name_form, $start_kolom, $search_column1, $search_cell_column_1, $search_cell_row_1, $search_column2, $search_cell_column_2, $search_cell_row_2, $jenis_id, $distrik, $lokasi_id)
  {
    ...
    $columns = RekapLRQuery::get_column_array_non_luar_jawa($start_kolom, $bulan, 2);
    if ($jenis_id == 2)
      $form_id = RekapLRQuery::get_file_import_revisi_non_luar_jawa($pgdl_file_import_revisi_id, 'form6_rutin_pgdl_file_import_revisi_id');
    elseif ($jenis_id == 3)
      $form_id = RekapLRQuery::get_file_import_revisi_non_luar_jawa($pgdl_file_import_revisi_id, 'form6_reimburse_pgdl_file_import_revisi_id');
    // elseif($jenis_id == 6)
    else
      $form_id = RekapLRQuery::get_file_import_revisi_non_luar_jawa($pgdl_file_import_revisi_id, 'form10_pln_pgdl_file_import_revisi_id');
  ...
  {
    // $array_bulan = RekapLRQuery::get_bulan_array($bulan);
    $array_lokasi = RekapLRQuery::get_location_array_non_luar_jawa($distrik->id, 'name', $lokasi_id);
    $form_id = RekapLRQuery::get_file_import_revisi_non_luar_jawa($pgdl_file_import_revisi_id, 'form_bahan_bakar_pgdl_file_import_revisi_id');
    if ($form_id == NULL)
      return 0;
    $data = DB::select("
  ...
  {
    // $locations = RekapLRQuery::get_location_array($distrik->id, 'id');
    ...
    $realisasi = DB::select("select realisasi from pgdl_realisasi_produksi_penjualan where lokasi_id = " . $lokasi_id . " and tahun_realisasi = " . $tahun . " and bulan_realisasi = " . $bulan . " and produksi_penjualan_id = " . $produksi_penjualan_id);
  ...
  static function get_column_array_non_luar_jawa($start_kolom, $bulan, $increment)
  {
    ...
    $columns = array();
    for ($i = 1; $i <= $bulan; $i++) {
      // ambil kolom dari bulan tsb saja, bukan akumulasi dari bulan2 sebelumnya
      if ($i == $bulan)
  ...
  static function get_bulan_by_judul_non_luar_jawa($judul_kolom)
  {
    ...
    $bulan = array_search($judul_kolom, $rkap_bulan);
    return $bulan;
  }
  ...
  static function get_rkap_sd_bulan_form_6_10($pgdl_file_import_revisi_id, $tahun, $bulan, $sheet_name_rkau, $sheet_name_form, $start_kolom, $search_column1, $search_cell_column_1, $search_cell_row_1, $search_column2, $search_cell_column_2, $search_cell_row_2, $jenis_id, $distrik)
  {
    ...
    $columns = RekapLRQuery::get_column_array($start_kolom, $bulan, 2);
    if ($jenis_id == 2)
      $form_id = RekapLRQuery::get_file_import_revisi($pgdl_file_import_revisi_id, 'form6_rutin_pgdl_file_import_revisi_id');
    elseif ($jenis_id == 3)
      $form_id = RekapLRQuery::get_file_import_revisi($pgdl_file_import_revisi_id, 'form6_reimburse_pgdl_file_import_revisi_id');
  ...
  {
    // $array_bulan = RekapLRQuery::get_bulan_array($bulan);
    $array_lokasi = RekapLRQuery::get_location_array($distrik->id, 'name');
    $form_id = RekapLRQuery::get_file_import_revisi($pgdl_file_import_revisi_id, 'form_bahan_bakar_pgdl_file_import_revisi_id');
    if ($form_id == NULL)
      return 0;
    $data = DB::select("
          SELECT sum(value::float) AS value
  ...
  static function get_realisasi_produksi_penjualan($tahun, $bulan, $distrik, $produksi_penjualan_id)
  {
    $locations = RekapLRQuery::get_location_array($distrik->id, 'id');
    // $realisasi = PgdlRealisasiProduksiPenjualan::where('tahun_realisasi', $tahun)->where('bulan_realisasi', $bulan)->whereIn('lokasi_id', $locations)->where('produksi_penjualan_id', $produksi_penjualan_id)->get();
    $realisasi = DB::select("select rencana from pgdl_rencana_produksi_penjualan
      where lokasi_id IN " . $locations . "
      and tahun_rencana = " . $tahun . "
      and bulan_rencana = " . $bulan . "
      and produksi_penjualan_id = " . $produksi_penjualan_id . "");

    $realisasi = !empty($realisasi) ? $realisasi[0]->rencana : 0;
    return $realisasi;
  }
  ...
  static function get_bulan_by_judul($judul_kolom)
  {
    $rkap_bulan = array('', 'RKAP Jan', 'RKAP Feb', 'RKAP Mar', 'RKAP Apr', 'RKAP May', 'RKAP Jun', 'RKAP Jul', 'RKAP Aug', 'RKAP Sep', 'RKAP Oct', 'RKAP Nov', 'RKAP Dec');
    $bulan = array_search($judul_kolom, $rkap_bulan);
    return $bulan;
