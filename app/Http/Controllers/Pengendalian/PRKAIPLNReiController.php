...
class PRKAIPLNReiController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($input_distrik != NULL) {
            ...
            $jenis_form_yg_digunakan = PgdlReportDashboardSetting::where('pgdl_report_dashboard_page_id', 3)
            ...
            if(count($jenis_form_yg_digunakan) == 0){
                ...
                return view('pengendalian_output.monitoring_prk_ai_pln_reimburse.index', compact('sb', 'fase', 'input_tahun', 'input_sb', 'input_distrik', 'input_lokasi', 'input_fase', 'input_draft_form_10_pln', 'dataparent', 'datainti','datakegiatan', 'distrik', 'lokasi','tahun', 'draft_form_10_pln', 'nama_bln_dipilih', 'name_draft_form_10_pln', 'notification_failed'));
            }
        ...
        if($input_draft_form_10_pln) {
            ...
            $pgdl_report_dashboard_page_id = 3;
            $jenis_id = 6;
            ...
            $form_10_pln_no_prk_kegiatan = $this->get_form_10($input_draft_form_10_pln,$int_input_distrik, $setting_no_prk_kegiatan->kolom);
            $form_10_pln_desc_prk_kegiatan = $this->get_form_10($input_draft_form_10_pln,$int_input_distrik, $setting_desc_prk_kegiatan->kolom);
            ...
            $form_10_pln_ai_ketetapan_update = $this->get_form_10_update($input_draft_form_10_pln,$int_input_distrik, $setting_ai_ketetapan_update->kolom);
            $form_10_pln_total_year_estimate_update = $this->get_form_10_update($input_draft_form_10_pln,$int_input_distrik, $setting_aki_ketetapan_update->kolom);
            ...
            for($i=0; $i<$int_count_10_pln; $i++){
                ...
                $cek_no_prk_ketetapan = $this->cek_no_prk_form_10_ketetapan($input_draft_form_10_pln,$int_input_distrik, $setting_no_prk_kegiatan->kolom, $form_10_pln_no_prk_kegiatan[$i]->value);
                ...
                if($cek_no_prk_ketetapan) {
                    ...
                    $ai_form_10_pln_ketetapan[$i] = $this->get_form_10_ketetapan($input_draft_form_10_pln,$int_input_distrik, $setting_ai_ketetapan->kolom, $setting_no_prk_kegiatan->kolom, $form_10_pln_no_prk_kegiatan[$i]->value)[0]->value;
                    $aki_form_10_pln_ketetapan[$i] = $this->get_form_10_ketetapan($input_draft_form_10_pln,$int_input_distrik, $setting_aki_ketetapan->kolom, $setting_no_prk_kegiatan->kolom, $form_10_pln_no_prk_kegiatan[$i]->value)[0]->value;
                }
                else {
                ...
                $dist_po_no = $this->get_no_po($form_10_pln_no_prk_kegiatan[$i]->value, $int_input_bulan, $input_tahun, $int_input_distrik);

//-------------------------------------------diakali disini------------------------------------------------------------
                if($dist_po_no){
                  foreach ($dist_po_no as $key => $value) {
                    $item_po = empty($this->get_itemp_po($form_10_pln_no_prk_kegiatan[$i]->value, $int_input_bulan, $value->po_no, $value->po_item, $value->account_code, $input_tahun)) ? '' : $this->get_itemp_po($form_10_pln_no_prk_kegiatan[$i]->value, $int_input_bulan, $value->po_no, $value->po_item, $value->account_code, $input_tahun)[0];
        ...
        foreach ($datakegiatan as $key_form => $value_per_form) {
            foreach ($value_per_form as $key => $value) {
                ...
                if(array_key_exists($prk_po_key, $data_prk_item)){
                    ...
                    $data_prk_item[$prk_po_key]['item_po']++;
            ...
            if($request->download && $request->type){
                ...
                if($request->type=='excel'){
                    Excel::create('Monitoring PRK AI PLN dan Reimburse', function ($excel) use($sb, $fase, $input_tahun, $input_sb, $input_distrik, $input_lokasi, $input_fase, $input_draft_form_10_pln, $dataparent, $datainti, $datakegiatan, $nama_bln_dipilih, $name_draft_form_10_pln, $data_prk_item) {
                            $excel->setTitle('Monitoring PRK AI PLN dan Reimburse');
                            $excel->setCreator('Laravel')->setCompany('Profio', 'PJB');
                            $excel->setDescription('Monitoring PRK AI PLN dan Reimburse');
                            $excel->sheet('Monitoring PRK AI', function ($sheet) use($sb, $fase, $input_tahun, $input_sb, $input_distrik, $input_lokasi, $input_fase, $input_draft_form_10_pln, $dataparent, $datainti, $datakegiatan, $nama_bln_dipilih, $name_draft_form_10_pln, $data_prk_item){
                                $sheet->loadView('pengendalian_output.monitoring_prk_ai_pln_reimburse.excel')
                                        ->with('sb', $sb)
                                        ->with('fase', $fase)
        ...
        return view('pengendalian_output.monitoring_prk_ai_pln_reimburse.index', compact('sb', 'fase', 'input_tahun', 'input_sb', 'input_distrik', 'input_lokasi', 'input_fase', 'input_draft_form_10_pln', 'dataparent', 'datainti','datakegiatan', 'distrik', 'lokasi','tahun', 'draft_form_10_pln', 'nama_bln_dipilih', 'name_draft_form_10_pln', 'notification_failed', 'data_prk_item'));
    }
