...
class DmrController extends Controller
{
    public function index()
    {
		...
		//dd($dmr);
        return view('dmr.daftar', compact('Sb', 'distrik', 'lokasi', 'input_sb', 'input_distrik', 'input_lokasi', 'input_tahun', 'dmr', 'role_spv_unit_dmr_tor', 'role_id'));
    }
    ...
    public function Ajax($id)
     {
        $ds = Distrik::where('strategi_bisnis_id', $id)->select("name","id","code1")->get();
    ...
    public function create(Request $request)
    {
        ...
        if ($request->isMethod('get')) {
            ...
            return view('dmr.tambah', $item,compact('distrik'));
        }
        ...
        elseif ($request->isMethod('post')) {
            ...
            $item = array(
                ...
                'sasaran_tujuan' => Input::get('sasaran_tujuan'),
                'permasalahan' => Input::get('permasalahan'),
                'alternatif_pencapaian' => Input::get('alternatif_pencapaian'),
                'benefit_finansial' => Input::get('benefit_finansial'),
                'benefit_operasional' => Input::get('benefit_operasional'),
            ...
            return redirect('dmr/daftar?tahun_anggaran='.$tahun_anggaran.'&strategi_bisnis='.$lokasi->distrik->strategi_bisnis_id.'&distrik='.$lokasi->distrik_id.'&lokasi='.$lokasi_id);
        }
    }
    ...
    public function update(Request $request,$id)
    {
        ...
        if ($request->isMethod('get')) {
            ...
            return view('dmr.edit', compact('dmr', 'dmr_review', 'lokasi', 'dmrattachment'));
        }
        ...
        elseif ($request->isMethod('post')) {
            ...
            $item->sasaran_tujuan = Input::get('sasaran_tujuan');
            $item->permasalahan = Input::get('permasalahan');
            $item->alternatif_pencapaian = Input::get('alternatif_pencapaian');
            $item->benefit_finansial = Input::get('benefit_finansial');
            $item->benefit_operasional = Input::get('benefit_operasional');
            ...
            return redirect('dmr/daftar?tahun_anggaran='.$item->tahun_anggaran.'&strategi_bisnis='.$item->lokasi->distrik->strategi_bisnis_id.'&distrik='.$item->lokasi->distrik_id.'&lokasi='.$item->lokasi_id);
        }
    }
    ...
    public function detail(Request $request,$id)
    {
        ...
        if ($request->isMethod('get')) {
            ...
            return view('dmr.detail', compact('role_id', 'dmr', 'dmrattachment', 'dmr_reviews', 'input_dmr_review', 'tor_attachments'));
        }
        ...
        elseif ($request->isMethod('post')) {
            ...
            return view('dmr.detail', compact('role_id', 'dmr', 'dmrattachment', 'dmr_reviews', 'input_dmr_review', 'dmr_review', 'tor_attachments'));
        }
    }
    ...
    public function delete(Request $request,$id)
    {
        ...
        if($item!= null){
            ...
            return redirect('dmr/daftar'.$return_path);
        }
        return redirect('dmr/daftar');
    }
