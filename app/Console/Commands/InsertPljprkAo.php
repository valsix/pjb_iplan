...
class InsertPljprkAo extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'insert:querypljprkao';
     ...
     * @var string
     */
    protected $description = 'Insert Query PLJPRK AO';
    ...
    public function handle()
    {
        ...
        foreach ($distrik as $key => $vdistrik) {
            $query_ao = $this->query_pljprk_ao($vdistrik->code1, $start_month, $finish_month);
            // $query_ao = $this->query_pljprk_ao('UBRS', $start_month, $finish_month);
